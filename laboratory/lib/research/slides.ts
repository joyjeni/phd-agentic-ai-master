...
export const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "To solve the research gap, four named modules are proposed. Each row is a thesis-sized design objective. Computational scores are not part of these objectives.",
    table: {
