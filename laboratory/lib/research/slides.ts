...
function referenceSlides(): Slide[] {
  const size = 8;
  const slides: Slide[] = [];
  for (let i = 0; i < BIBLIOGRAPHY.length; i += size) {
    const chunk = BIBLIOGRAPHY.slice(i, i + size);
    ...
    slides.push({
      ...
      footnote:
        page === 1
          ? "Contents item 11. CrewAI is an engineering framework without a flagship peer-reviewed paper in this list."
          : undefined,
    });
  }
  return slides;
...
export const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    bullets: [...MOTIVATION.bullets],
    footnote: "Source: docs/RESEARCH_OBJECTIVES.md (canonical: lib/research/objectives.ts).",
  },
    ...
    table: {
      ...
      rows: [
        ...
        [
          ...
          "Training-free hop sampling over named tool-specialist agents",
        ],
        [
  ...
  },
  {
    ...
    title: "Research Objectives — overall",
    body: OVERALL_OBJECTIVE.statement,
    bullets: [...OVERALL_OBJECTIVE.scope],
    footnote: "Source: docs/RESEARCH_OBJECTIVES.md (canonical: lib/research/objectives.ts).",
  },
  {
    id: "objectives",
    section: "Research Objectives",
    title: "Research Objectives — individual",
    body: "Four thesis-sized design objectives follow from the overall aim. Each is a To-design statement. Computational scores are not part of these objectives.",
    table: {
      headers: ["ID", "Name", "Design objective"],
      rows: OBJECTIVES.map((o) => [o.code, o.title, o.objective]),
    },
  },
  {
    id: "o1-satr",
    ...
    body: OBJECTIVES[0].objective,
    bullets: [
      `Artefact. ${OBJECTIVES[0].outputs}`,
      `What will be designed. ${OBJECTIVES[0].journalDefinition}`,
  ...
  },
  {
    ...
    body: OBJECTIVES[1].objective,
    bullets: [
      `Artefact. ${OBJECTIVES[1].outputs}`,
      `What will be designed. ${OBJECTIVES[1].journalDefinition}`,
  ...
  },
  {
    ...
    body: OBJECTIVES[2].objective,
    bullets: [
      `Artefact. ${OBJECTIVES[2].outputs}`,
      `What will be designed. ${OBJECTIVES[2].journalDefinition}`,
  ...
  },
  {
    ...
    body: OBJECTIVES[3].objective,
    bullets: [
      `Artefact. ${OBJECTIVES[3].outputs}`,
      `What will be designed. ${OBJECTIVES[3].journalDefinition}`,
  ...
  {
    id: "objectives-nonclaim",
    section: "Research Objectives",
    title: NON_CLAIMS.title,
    body: NON_CLAIMS.statement,
    bullets: [
    ...
    footnote: "Same text as docs/RESEARCH_OBJECTIVES.md. Story so far: motivation → overall aim → O1–O4 → this non-claim → research questions.",
  },
  {
    id: "questions",
  ...
  },
  {
    ...
    body: "How session-aware ranking will be designed. Computational retrieval scores are not part of this objective.",
  ...
  },
  {
    ...
    body: "How specialist hops will be designed. Computational routing scores are not part of this objective.",
  ...
  },
  {
    ...
    body: "How mesh pruning will be designed. Computational compression ratios are not part of this objective.",
  ...
  },
  {
    ...
    body: "Pseudocode is the laboratory functions. Full listings are on /algorithms. Journal mermaid redraws of every archived GitHub diagrams/ PNG are on /diagrams. Constants are repository defaults, not claimed results.",
    bullets: [
...
export const OUTLINE: ContentsItem[] = [
  ...
  { n: "11", title: "References", slideId: "refs-1" },
];
...
function slideToMarkdown(slide: Slide, index: number): string {
  ...
  for (const paragraph of slide.paragraphs ?? []) {
    lines.push(linkDoisMarkdown(paragraph), "");
  }
  ...
  if (!slide.evidence?.length) {
    for (const bullet of slide.bullets ?? []) {
      lines.push(`- ${linkDoisMarkdown(bullet)}`);
    }
